...
const ARArrayHome = () => {
  ...
  const createTextTexture = (text, color = "black", bg = "white", fontSize = 100) => {
    ...
    <div style={{ width: "100%", height: "100vh", position: "relative" }}>
      ...
      <div style={panelStyle}>
        ...
        <div style={smallHintStyle}>
          {rendererRef.current && rendererRef.current.xr && rendererRef.current.xr.isPresenting
            ? placed
...
>>>>>>> 464563b4476880381fc146e91443444868aca9df
